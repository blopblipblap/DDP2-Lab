...
public class NongSkuy{
    ...
    public static ArrayList<Place> searchPlace(int maxPrice) {
        ...
        ArrayList<Place> maxPlace = new ArrayList<>();
        for (Place tempat : placeList) {
            if (tempat.getMinPrice() <= maxPrice) {
                maxPlace.add(tempat);
            }
        }
        return maxPlace;
    ...
    public static ArrayList<Place> searchPlace(int minPrice, int maxPrice) {
        // TODO: Implementasi method ini
        ArrayList<Place> minMaxPlace = new ArrayList<>();
        for (Place tempat : placeList) {
            if (minPrice <= tempat.getMinPrice() && tempat.getMaxPrice() <= maxPrice) {
                minMaxPlace.add(tempat);
            }
        }
        return minMaxPlace;
    }
